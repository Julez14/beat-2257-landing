...
const icons = [
  {
    ...
    alt: "ChatGPT",
    className: "hidden sm:block absolute top-[20%] left-[10%] drop-shadow-lg w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 -rotate-12 transition-all hover:scale-105 hover:-rotate-6",
  },
  {
    ...
    alt: "Claude",
    className: "hidden sm:block absolute bottom-[20%] left-[15%] drop-shadow-lg w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rotate-12 transition-all hover:scale-105 hover:rotate-6",
  },
  {
    ...
    alt: "Perplexity",
    className: "hidden sm:block absolute top-[20%] right-[10%] drop-shadow-lg w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rotate-12 transition-all hover:scale-105 hover:rotate-6",
  },
  {
    ...
    alt: "Gemini",
    className: "hidden sm:block absolute bottom-[20%] right-[15%] drop-shadow-lg w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 -rotate-12 transition-all hover:scale-105 hover:-rotate-6",
  },
];
...
const AllAiSection = () => {
  return (
    <section className="container">
      <div className="relative bg-secondary rounded-xl lg:rounded-2xl my-12 lg:my-24 py-16 lg:py-24 px-8 sm:px-12 md:px-16 lg:px-24">
        {icons.map((icon) => (
          <Image
            key={icon.alt}
            src={icon.src}
